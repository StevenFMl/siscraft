...
export default function OrdenViewModal({
  isOpen,
  onClose,
  orden,
}: OrdenViewModalProps) {
  ...
  const getMetodoPago = (metodo: string) => {
    switch (metodo) {
      ...
      case "efectivo": // Añadido para ser explícito
        return "Efectivo";
      default:
        return "Efectivo"; // O cualquier otro valor por defecto
    }
  };
      ...
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="border-t border-b border-gray-200 py-4">
            ...
            <p className="text-sm">
              Método de pago: {getMetodoPago(orden.metodo_pago)}
            </p>
            {orden.notas && (
              <p className="text-sm mt-2">Notas: {orden.notas}</p>
            )}
          </div>
